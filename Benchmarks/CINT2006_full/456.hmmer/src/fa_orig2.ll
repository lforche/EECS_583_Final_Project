...
define dso_local float @P7Viterbi(i8* noundef %dsq, i32 noundef %L, %struct.plan7_s* noundef %hmm, %struct.dpmatrix_s* noundef %mx, %struct.p7trace_s** noundef %ret_tr) local_unnamed_addr #0 !dbg !11 {
entry:
...
declare dso_local void @ResizePlan7Matrix(%struct.dpmatrix_s* noundef, i32 noundef, i32 noundef, i32*** noundef, i32*** noundef, i32*** noundef, i32*** noundef) local_unnamed_addr #2

declare dso_local void @P7ViterbiTrace(%struct.plan7_s* noundef, i8* noundef, i32 noundef, %struct.dpmatrix_s* noundef, %struct.p7trace_s** noundef) local_unnamed_addr #2

declare dso_local float @Scorify(i32 noundef) local_unnamed_addr #2
