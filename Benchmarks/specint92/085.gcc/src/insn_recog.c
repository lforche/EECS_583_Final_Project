     ...
     rtx insn;
{
 ...
 L679:
  ...
  if (GET_CODE (x3) == CONST_INT && XINT (x3, 0) == 24 && 1)
    ...
    && (INTVAL (operands[0]) & ~0xff) == 0)) return 163;
  x2 = XEXP (x1, 0);
  goto L683;
 L684:
  x3 = XEXP (x2, 0);
 ...
 L686:
  ...
  if (general_operand (x2, QImode))
    ...
    && (INTVAL (operands[1]) & ~0xff) == 0)) return 164; }
  x2 = XEXP (x1, 0);
  goto L690;
 L691:
  x2 = XEXP (x1, 1);
 ...
 L693:
  ...
  if (GET_CODE (x3) == CONST_INT && XINT (x3, 0) == 24 && 1)
    if ((GET_CODE (operands[0]) == CONST_INT
    && ((INTVAL (operands[0]) + 0x80) & ~0xff) == 0)) return 165;
  x2 = XEXP (x1, 0);
  goto L697;
 L698:
  x3 = XEXP (x2, 0);
 ...
 L700:
  ...
  if (general_operand (x2, QImode))
    { recog_operand[1] = x2; if ((GET_CODE (operands[1]) == CONST_INT
    && ((INTVAL (operands[1]) + 0x80) & ~0xff) == 0)) return 166; }
  goto ret0;
 L77:
  x2 = XEXP (x1, 0);
 ...
 L115:
  if (general_operand (x2, SImode))
    { recog_operand[1] = x2; if (GET_CODE (operands[1]) == CONST_INT) return 24; }
  x2 = XEXP (x1, 0);
  goto L119;
 L80:
  x3 = XEXP (x2, 0);
