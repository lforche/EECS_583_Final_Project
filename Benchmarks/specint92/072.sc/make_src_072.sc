...
SRC_FILES="cmds.c crypt.c experres.h gram.c help.c interp.c \
           lex.c range.c sc.c sc.h statres.h xmalloc.c y_tab.h"


# Files from ./
LOCAL_FILES="lib_src/curses.c lib_src/curses.h"
