...
/* 
   Changed the order of the following includes so that correct
   definitions of MIN and MAX are used
   as requested by Data General.

#include "sc.h"
#include <signal.h>

   Undefined MIN and MAX which are already defined by signal.h
   as requested by Data General.
   - Kaivalya and Prasad, SMCC, 08/06/91
